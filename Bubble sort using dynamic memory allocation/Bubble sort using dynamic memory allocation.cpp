...
* It accept a value form user and put it in "size".
*/
...
*
* "cout" is an object of class ostream.
* In this line it will display "Enter element " and tha value of "i".
*/
...
* If the value of "counter" is smaller then the value of "size" then the "while loop" will execute.
*/
...
* Line 27 :
*
* "counter++" is a increment operator.
